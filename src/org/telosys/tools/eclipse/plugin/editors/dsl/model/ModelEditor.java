...
//	private String          _currentBundle = null ; // v 2.0.7
	...
	private ModelEditorPageCodeGeneration _page1 = null ;
	private ModelEditorPageModelInfo _page2 = null ;
...
//		_model = loadModel( _file );
	...
	protected void addPages() {
		...
		_page1 = new ModelEditorPageCodeGeneration(this, "ModelEditorPage1", PAGE_1_TITLE );
		_page2 = new ModelEditorPageModelInfo(this, "ModelEditorPage2", PAGE_2_TITLE );
		try {
			addPage(_page1);
			addPage(_page2);
